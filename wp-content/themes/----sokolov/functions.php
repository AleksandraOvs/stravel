...
function juliet_setup()
{
    ...
    register_nav_menus(array(
        'header'    => esc_html__('Main Menu', 'juliet'),
    ...
    function juliet_get_bootstrap_class($columns)
    {
        switch ($columns) {
            ...
            case 5:
                ...
                break;
            case 6:
                return 'col-lg-2 col-md-2 col-sm-2 col-xs-6';
                break;
        }
    }
endif;
...
if (! function_exists('juliet_get_sample')) :
    function juliet_get_sample($what)
    {
        global $juliet_defaults;
        switch ($what) {
            case 'juliet-thumbnail':
                $images = $juliet_defaults['juliet_thumbnail_sample'];
                $rand_key = array_rand($images, 1);
                return ($images[$rand_key]);
            case 'juliet-full':
                $images = $juliet_defaults['juliet_full_sample'];
                $rand_key = array_rand($images, 1);
                return ($images[$rand_key]);
            case 'juliet-featured':
                $images = $juliet_defaults['juliet_featured_sample'];
                $rand_key = array_rand($images, 1);
                return ($images[$rand_key]);
        }
    }
...
//     the_widget('WP_Widget_Pages', 'title=Страницы', 'before_title=<h3 class="widget-title">&after_title=</h3>&before_widget=<div class="footer-row-1-widget widget">&after_widget=</div>');
//     echo '</div>';

//     echo '<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">';
//     the_widget( 'WP_Widget_Archives', 'title=Архивы', 'before_title=<h3 class="widget-title">&after_title=</h3>&before_widget=<div class="footer-row-1-widget widget">&after_widget=</div>');
//     echo '</div>';

//     echo '<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">';
//     the_widget('WP_Widget_Recent_Posts', 'title=Последние записи', 'before_title=<h3 class="widget-title">&after_title=</h3>&before_widget=<div class="footer-row-1-widget widget">&after_widget=</div>');
//     echo '</div>';

//     echo '<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">';
//     the_widget( 'WP_Widget_Categories', 'title=Рубрики', 'before_title=<h3 class="widget-title">&after_title=</h3>&before_widget=<div class="footer-row-1-widget widget ">&after_widget=</div>');
//     echo '</div>';
...
//     the_widget('WP_Widget_Search', 'title=' . esc_html__('Поиск', 'juliet'), 'before_title=<h3 class="widget-title">&after_title=</h3>&before_widget=<div class="default-widget widget widget_search">&after_widget=</div>');
//     the_widget('WP_Widget_Pages', 'title=' . esc_html__('Страницы', 'juliet') , 'before_title=<h3 class="widget-title">&after_title=</h3>&before_widget=<div class="default-widget widget">&after_widget=</div>');
//     the_widget('WP_Widget_Recent_Posts', 'title=' . esc_html__('Последние записи', 'juliet') , 'before_title=<h3 class="widget-title">&after_title=</h3>&before_widget=<div class="default-widget widget">&after_widget=</div>');
//     the_widget( 'WP_Widget_Archives', 'title=' . esc_html__('Архивы', 'juliet'), 'before_title=<h3 class="widget-title">&after_title=</h3>&before_widget=<div class="default-widget widget">&after_widget=</div>');
//     the_widget( 'WP_Widget_Categories', 'title=' . esc_html__('Рубрики', 'juliet'), 'before_title=<h3 class="widget-title">&after_title=</h3>&before_widget=<div class="default-widget widget">&after_widget=</div>');
//     echo '</div>';
// }
