...
$juliet_defaults['juliet_footer_copyright']                 = esc_html__('Все права защищены &copy; ', 'juliet'). date('Y') .' <p><a href="https://www.lyrathemes.com/juliet/" target="_blank">LyraThemes.com</a> &nbsp; <a href="https://babymir.net/" title="Детский сайт для молодой мамы" rel="nofollow" target="_blank">Babymir.net</a></p>';
...
$juliet_defaults['juliet_frontpage_featured_posts_heading'] = esc_html__('Прикрепленные записи', 'juliet');
...
$juliet_defaults['juliet_blog_feed_label']					= esc_html__('Последние записи', 'juliet');
